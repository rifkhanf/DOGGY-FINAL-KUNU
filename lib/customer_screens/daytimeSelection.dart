...
class _DayTimeSelectionPageState extends State<DayTimeSelectionPage> {
  ...
  void _selectTime(String day) async {
    ...
    if (pickedTime != null &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Please Select A Time Between 8 AM - 10 AM or 3 PM - 5 PM')),
      );
    }
  }
  ...
  Future<void> _saveSelection() async {
    ...
    Navigator.pushReplacementNamed(context, '/customersub');
  }
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: selectedDays[day] != null
                              ? Text('Selected time: ${selectedDays[day]!.format(context)}')
                              : null,
                        ),
                      );
                    }).toList(),
