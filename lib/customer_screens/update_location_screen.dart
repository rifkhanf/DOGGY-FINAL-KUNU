...
class _UpdateLocationScreenState extends State<UpdateLocationScreen> {
  ...
  bool _isSaveButtonEnabled = false; // To track if the save button should be enabled
          ...
          _routeMarkers.add(Marker(
            ...
            onDragEnd: (newPosition) {
              setState(() {
                ...
                _isSaveButtonEnabled = true; // Enable the save button when the marker is dragged
              });
            },
          ));
        });
  ...
  Future<void> _saveLocation() async {
    ...
    if (_lastUpdated != null &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('You can only update your location once a week.')),
      );
      return;
    }
    ...
    try {
      ...
      if (user != null) {
        await FirebaseFirestore.instance.collection('users').doc(user.uid).update({
          'saved_location': GeoPoint(_hoverLocation!.latitude, _hoverLocation!.longitude),
        ...
        child: Column(
          children: [
            Text(
              ...
              'Note: You can only update your location once a week.',
              style: TextStyle(
                fontSize: 16,
                fontWeight: FontWeight.bold,
            ...
            Expanded(
              child: Container(
                height: MediaQuery.of(context).size.height * 0.5, // Smaller map height
            ...
            ElevatedButton.icon(
              ...
              label: Text('Edit Location Once A Week'),
