...
class SubscriptionPage extends StatelessWidget {
  ...
  SubscriptionPage({required this.userName});
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              'Thank you for registering with KUNU.LK. Here are the benefits of subscribing:',
            ...
            ElevatedButton(
              ...
              onPressed: () {
                // Navigate to the dummy payment gateway
                Navigator.push(
                  context,
