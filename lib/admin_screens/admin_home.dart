        ...
        child: Container(
          ...
          child: ListView(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => ManageBinsPage()),
                  );
                },
              ),
              ListTile(
              ...
              const Divider(), // Optional divider to separate the logout option
              ListTile(
              ...
              builder: (context, snapshot) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    leading: Icon(Icons.route, color: Colors.yellow[800]),
                    title: const Text('Number of Garbage Routes'),
              ...
              builder: (context, snapshot) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    contentPadding: const EdgeInsets.all(16.0),
                    leading: Icon(Icons.people, color: Colors.yellow[800]),
                    title: const Text('Number of Customers'),
              ...
              builder: (context, snapshot) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    contentPadding: const EdgeInsets.all(16.0),
                    leading: Icon(Icons.person, color: Colors.yellow[800]),
                    title: const Text('Number of Garbage Collectors'),
