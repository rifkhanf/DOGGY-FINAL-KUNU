                      ...
                      child: Stack(
                        ...
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.only(top: 30), // Adjusted margin to move form higher
                            decoration: BoxDecoration(
                              color: Colors.white,
                            ...
                            child: Form(
                              ...
                              child: Column(
                                ...
                                children: [
                                  SizedBox(height: 10), // Adjusted space for the logo
                                  TextFormField(
                          ...
                          Positioned(
                            top: 0, // Adjusted position to move logo higher but visible
                            child: ClipRRect(
