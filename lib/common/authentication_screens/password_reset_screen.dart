...
class _PasswordResetPageState extends State<PasswordResetPage> {
                              ...
                              child: Form(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 24),
                                    buildGradientButton(context, 'Reset Password', resetPassword),
                                    SizedBox(height: 16),
                                    buildGradientButton(
                                      context,
                                      'Back to Login',
                                      () => Navigator.pop(context),
                                      gradientColors: [Colors.grey[500]!, Colors.grey[700]!],
                                    ),
                                  ],
                                ),
                              ),
  ...
  Widget buildGradientButton(
    ...
    gradientColors ??= [Colors.orange[600]!, Colors.red[400]!]; // Default gradient
